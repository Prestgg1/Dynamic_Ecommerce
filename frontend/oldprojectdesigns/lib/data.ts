...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Müxtəlif ölçüdə 5 ədəd dəmir çəkic. Ağır iş şərtləri üçün.",
    descriptionRu: "5 молотков разного размера. Для тяжёлых условий работы.",
    descriptionEn: "5 hammers of different sizes. For heavy-duty work.",
    price: 45.5,
    rating: 4.5,
    reviewCount: 87,
    category: "tools",
  ...
  },
  {
    ...
    description: "Müxtəlif ölçüdə 500 ədəd vida. Tikinti işləri üçün ideal.",
    descriptionRu:
  ...
  },
  {
    ...
    descriptionRu:
      "Профессиональный MIG сварочный аппарат. Мощность 200А, для быстрой сварки.",
    descriptionEn:
  ...
  },
  {
    ...
    descriptionRu: "Медный электрический кабель 2,5мм². Рулон 100 метров.",
  ...
  },
  {
    ...
    description: "Qapı qurğuları, mişar, bağlama hissələri daxil olmaqla tam dəst.",
    descriptionRu:
      "Полный набор включая дверную фурнитуру, петли, крепёжные элементы.",
    descriptionEn:
  ...
  },
  {
    ...
    description: "Dəqiq ölçü üçün paslanmayan poladdan hazırlanmış 1 metrlik xətt.",
    descriptionRu: "Стальная линейка 1 метр из нержавеющей стали для точных измерений.",
    descriptionEn: "1 meter stainless steel ruler for precise measurements.",
    price: 12.99,
    rating: 4.6,
    reviewCount: 200,
    category: "tools",
  ...
  },
  {
    ...
    description: "DN50 ölçüsündə paslanmayan polad flanç. Sənaye xətləri üçün.",
    descriptionRu: "Фланец нержавеющий DN50. Для промышленных трубопроводов.",
  ...
  },
  {
    ...
    description: "İnşaat sahəsi və anbar üçün 50W LED işıq. IP65 su keçirməzlik.",
    descriptionRu: "50W LED светильник для стройплощадки и склада. Водозащита IP65.",
    descriptionEn: "50W LED light for construction site and warehouse. IP65 waterproof.",
    price: 42.0,
    oldPrice: 55.0,
    rating: 4.5,
    reviewCount: 68,
